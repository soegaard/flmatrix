...
@; raco scribble +m --dest html --redirect-main http://docs.racket-lang.org flmatrix.scrbl && open html/flmatrix.html
...
@title[#:tag "flmatrix" #:style (with-html5 manual-doc-style)]{Flmatrix: Floating Point Matrices}
